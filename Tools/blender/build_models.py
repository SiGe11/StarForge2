...
def build_ore():
    ...
    shards = [(0.02, 0.00, 2.25, 0.38, 0.05),
              ...
              # Slender needles among the prisms: the silhouette bristles instead
              # of reading as a few blunt blocks.
              (0.10, 0.24, 1.72, 0.10, 0.16),
              (-0.26, -0.04, 1.30, 0.09, 0.22),
              (0.30, -0.30, 1.18, 0.08, 0.30),
              (-0.10, -0.30, 1.44, 0.09, 0.20),
              (0.44, 0.06, 0.98, 0.07, 0.40),
              (-0.44, 0.24, 0.86, 0.07, 0.44)]
